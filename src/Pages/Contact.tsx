        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-4xl font-bold text-gray-900 mb-4">{settings?.site_name || '2030Maroc'} - Restons en contact</h2>
            ...
            <div className="grid md:grid-cols-2 gap-12">
              ...
              <motion.div
                ...
                className="bg-green-50 p-8 rounded-2xl shadow-xl"
              >
                ...
                <div className="grid grid-cols-1 gap-6">
                  {contactInfo.map((item, index) => (
                    <motion.a
                      ...
                      className="flex items-start p-6 bg-green-50 rounded-xl shadow-lg hover:shadow-xl transition-shadow"
                      whileHover={{ y: -5 }}
                    >
