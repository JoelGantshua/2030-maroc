...
const Evenements = () => {
  ...
  return (
    <div className="min-h-screen bg-green-100 bg-gradient-to-b from-green-100 to-green-50">
      {/* Hero Section */}
      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {events.map((event) => (
            <motion.div
              key={event.id}
              className="bg-green-50 rounded-xl overflow-hidden shadow-lg hover:shadow-2xl transition-shadow duration-300"
              whileHover={{ y: -5 }}
            >
        ...
        {/* Newsletter Section */}
        <div className="px-15 py-5 bg-black/30 text-primary font-medium rounded-lg hover:bg-green-50 transition-colors mx-auto mt-10">
