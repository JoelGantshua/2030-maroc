  ...
  return (
    <div className="min-h-screen bg-green-100">
      ...
      <div className="relative h-96 overflow-hidden">
        ...
        <button
          onClick={prevSlide}
          className="absolute left-4 top-1/2 -translate-y-1/2 bg-green-100/20 hover:bg-green-100/30 text-white p-3 rounded-full backdrop-blur-sm transition-all"
        ...
        <button
          onClick={nextSlide}
          className="absolute right-4 top-1/2 -translate-y-1/2 bg-green-100/20 hover:bg-green-100/30 text-white p-3 rounded-full backdrop-blur-sm transition-all"
          ...
          {heroImages.map((_, index) => (
            <button
              ...
              className={`w-3 h-3 rounded-full transition-all ${
                index === currentSlide ? 'bg-green-100 w-8' : 'bg-green-100/50'
              }`}
      ...
      {filteredAnnonces.length === 0 ? (
        <div className="bg-green-50 rounded-lg shadow-md p-12 text-center">
