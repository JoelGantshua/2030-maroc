...
const Home: React.FC<HomeProps> = ({ onOpenBooking }) => {
  ...
  return (
    <div className="overflow-x-hidden">
      ...
      {/* Section Services */}
      <section className="relative py-20 bg-gradient-to-b from-green-50 to-green-100">
        <div className="container mx-auto px-4">
          ...
          >
                    ...
                    {activeServiceData && (
                      <>
                        ...
                        <button 
                          ...
                          className="inline-flex items-center bg-green-700 text-black px-6 py-3 rounded-full font-medium hover:bg-green-700 transition-all duration-300 transform hover:scale-105"
                        >
            ...
            <button 
              onClick={prevService}
              className="absolute left-4 top-1/2 -translate-y-1/2 z-30 bg-green 700/40 hover:bg-green 700 text-white p-3 rounded-full transition-all duration-300 transform hover:scale-110"
            ...
            <button 
              onClick={nextService}
              className="absolute right-4 top-1/2 -translate-y-1/2 z-30 bg-green-700/40 hover:bg-green-700 text-white p-3 rounded-full transition-all duration-300 transform hover:scale-110"
              ...
              {services.map((_, index) => (
                <button
                  ...
                  className={`w-3 h-3 rounded-full transition-all duration-30 ${
                    index === activeService ? 'bg-green-100 w-8' : 'bg-white/50 hover:bg-white/80'
                  }`}
          ...
          >
            {services.map((service) => (
              <motion.div 
                key={service.title}
                variants={item}
                className="bg-green-50 rounded-xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2"
              >
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            {[
              ...
              <motion.div 
                key={index}
                className="bg-green-50 rounded-xl overflow-hidden shadow-lg hover:shadow-xl transition-shadow"
                whileHover={{ y: -5 }}
              >
                <div className="h-48 overflow-hidden">
                  <img 
      ...
      {/* CTA Section */}
      <section className="py-20 bg-gradient-to-r bg-black/30 to-green-100 text-black">
        <div className="container mx-auto px-3 text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            ...
            <button 
              ...
              className="px-8 py-3 border-2 border-white text-black font-medium rounded-lg hover:bg-white/10 transition-colors"
            >
              Appelez-nous
            </button>
          </div>
