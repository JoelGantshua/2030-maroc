...
const Navbar: React.FC<NavbarProps> = () => {
  ...
  return (
    <nav className="bg-green-700 shadow-md fixed w-full z-50">
          ...
          <div className="flex items-center">
            <Link to="/" className="shrink-0 flex items-center p-0">
              <h1 className="text-primary m-0 text-xl font-bold" style={{ fontSize: '1.6rem' }}>
                <i className="fa fa-map-marker-alt mr-2"></i>2030 Maroc
              </h1>
            </Link>
          </div>
          ...
          <div className="flex items-center">
            ...
            {!profile ? (
              <Link
                ...
                className="ml-4 bg-linear-to-r from-black-400 to-yellow-400 text-black px-5 py-2.5 rounded-lg text-sm font-bold hover:from-yellow-700 hover:to-green-400 transition-all duration-300 shadow-md hover:shadow-lg flex items-center gap-2"
              >
