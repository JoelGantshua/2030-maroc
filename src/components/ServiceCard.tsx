    ...
    >
      <Link to={`/${servicePath}/${id}`} className="block">
        <div className="relative h-48 overflow-hidden group">
          ...
          {featured && (
            <div className="absolute top-2 left-2 bg-green-700 text-green-700 text-xs font-bold px-2 py-1 rounded">
              En vedette
            </div>
          )}
            ...
            <div className="flex items-center">
              {rating > 0 && (
                <div className="flex items-center mr-2">
                  <StarIcon className="w-4 h-4 text-green-700 fill-green-700" />
