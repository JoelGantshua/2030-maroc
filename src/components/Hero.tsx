  ...
  return (
    <section className="relative h-[90vh] overflow-hidden">
      ...
      <button 
        ...
        className="absolute left-4 top-1/2 -translate-y-1/2 z-20 p-3 rounded-full bg-green-700/90 text-gray-800 hover:bg-green-700 hover:text-primary transition-all duration-300 shadow-lg hover:shadow-xl"
      ...
      <button 
        ...
        className="absolute right-4 top-1/2 -translate-y-1/2 z-20 p-3 rounded-full bg-green-700/90 text-gray-800 hover:bg-green-700 hover:text-primary transition-all duration-300 shadow-lg hover:shadow-xl"
        aria-label="Suivant"
      >
      ...
      <div className="absolute bottom-8 left-1/2 -translate-x-1/2 z-20 flex gap-2">
        {slides.map((_, index) => (
          <button
            ...
            className={`w-3 h-3 rounded-full transition-all duration-300 shadow-md ${currentSlide === index ? 'bg-green-700 w-8 shadow-lg' : 'bg-green-700/60 hover:bg-green-700/90'}`}
